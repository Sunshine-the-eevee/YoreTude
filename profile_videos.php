...
<a href="profile_videos.php?user=<?php echo htmlspecialchars($profile["username"]); ?>" class="bold">Videos</a> (<?php echo $profile['videos']; ?>)
<span style="padding-right: 5px; padding-left: 5px;">|</span>
		...
		<td>
			<div class="watchTitleBar">
				<table width="100%" cellpadding="0" cellspacing="0" border="0">
					<tr valign="top">
						<td><div class="watchTitle">Videos // <span style="text-transform: capitalize;"><?php echo htmlspecialchars($profile['username']); ?></span></div></td>
					</tr>
				</table>
			</div>
			<?php if($videos !== false) { ?>
